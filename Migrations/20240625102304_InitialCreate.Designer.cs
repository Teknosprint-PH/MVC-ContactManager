...
namespace tech_challenge.Migrations
{
    ...
    [Migration("20240625102304_InitialCreate")]
            ...
            modelBuilder.Entity("tech_challenge.Models.Contact_Info", b =>
                {
                    ...
                    b.Property<double?>("location_lat")
                        .HasColumnType("float")
                        .HasColumnName("location_lat");

                    b.Property<double?>("location_long")
                        .HasColumnType("float")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            contact_status = "AC",
                            created_by = "JCASO",
                            created_dt = new DateTime(2024, 6, 25, 18, 23, 4, 449, DateTimeKind.Local).AddTicks(3118),
